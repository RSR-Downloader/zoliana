...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/RSR-Downloader/zoliana)
...
This file should be placed in your `Hexzy` folder, alongside the `__main__.py` file. 
...
```
from Hexzy.sample_config import Config
